...
.wb-freecell .fc-card{display:block;position:relative;height:clamp(65px,9vw,96px);padding:5px 3px;border:1px solid #c4c6bc;border-radius:5px;background:#fffdf5;color:#202b2e;text-align:left;line-height:1.1;font:bold clamp(12px,2.1vw,20px)/1.1 Georgia,serif;box-shadow:0 2px 3px #0003;cursor:pointer;touch-action:manipulation}
